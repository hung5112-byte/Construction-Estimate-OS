---
name: ce-scope-gap-auditor
description: 'Scope Gap Auditor — 06-estimate-review. Coverage report: unclaimed sheets, divisions with requirements but no lines, items in zero or two packages'
