...
│   └── cli.py
├── departments/                       # 13 core departments (YAML + agent .md)
├── packs/                             # F&B, Retail, Tech-SaaS
├── templates-us/                      # 191 templates from bb-plugin (vendored)
├── vault-template/                    # Obsidian scaffold for onboard
...
3. `repo/templates-us/<dept>/` — 191 default templates from bb-plugin (vendored)
