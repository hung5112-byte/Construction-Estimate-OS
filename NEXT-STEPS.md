...
5. plans/plan.md      — overview of the 6 phases
...
├── templates-us/                 # 192 .md from bb-plugin (vendored)
...
- 192 templates in `templates-us/` (originally authored in Vietnamese, localized to US English) from `references/business-builder.plugin`.
...
1. Everything is prepared; the detailed 65-task plan is in `plans/`
