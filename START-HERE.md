...
5. Read plans/plan.md — overview of the 6 phases
...
- **`references/business-builder.plugin`:** the source zip — contains 192 templates (originally authored in Vietnamese, now localized to US English) vendored into `templates-us/`
...
| Skip the 6-RULES check on each commit | Run `scripts/dev/check-domain-neutral.sh` |
