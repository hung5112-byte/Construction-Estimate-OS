...
## Your teams
- [[docs/departments/03-architectural/agents/envelope-estimator]] — low-slope roofing systems
- [[docs/departments/03-architectural/agents/interiors-estimator]] — partition types
- [[docs/departments/03-architectural/agents/openings-estimator]] — door schedules
- [[docs/departments/03-architectural/agents/specialties-equipment-estimator]] — division 10 specialties
