...
## Works with
- [[docs/departments/01-hardware-engineering/agents/me-team]] — board outline, thermal interfaces
- [[docs/departments/01-hardware-engineering/agents/fw-embedded-team]] — bring-up, pin maps, debug hooks
