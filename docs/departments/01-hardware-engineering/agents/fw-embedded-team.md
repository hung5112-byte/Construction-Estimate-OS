...
4. Define release gates with [[docs/departments/03-quality-reliability/agents/firmware-qa]] before committing dates
5. Hand off: test plans to [[docs/departments/03-quality-reliability/agents/firmware-qa]], provisioning specs to [[docs/departments/02-npi-program-management/agents/odm-program-mgmt]] for the factory, fault-code maps to [[docs/departments/03-quality-reliability/agents/field-quality-rma-fa]]
...
## Works with
- [[docs/departments/01-hardware-engineering/agents/ee-team]] — bring-up and debug hooks
- [[docs/departments/03-quality-reliability/agents/firmware-qa]] — release gates and regression scope
- [[docs/departments/02-npi-program-management/agents/certification]] — security-relevant changes that re-trigger approvals
