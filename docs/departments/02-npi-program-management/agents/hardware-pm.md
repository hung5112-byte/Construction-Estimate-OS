...
5. Hand off: build slots to [[docs/departments/02-npi-program-management/agents/odm-program-mgmt]], material gaps to [[docs/departments/02-npi-program-management/agents/sourcing-buyer]], gate criteria to [[docs/departments/03-quality-reliability/agents/quality-manager]]
...
## Works with
- [[docs/departments/02-npi-program-management/agents/bom-eco-plm]] — change cut-ins vs. build phases
- [[docs/departments/02-npi-program-management/agents/launch-readiness]] — ramp entry criteria
