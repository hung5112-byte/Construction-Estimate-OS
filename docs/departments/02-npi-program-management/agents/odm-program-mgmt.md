...
5. Hand off: material gaps to [[docs/departments/02-npi-program-management/agents/sourcing-buyer]], quality issues to [[docs/departments/04-mfg-supplier-quality/agents/odm-quality]], change cut-ins from [[docs/departments/02-npi-program-management/agents/bom-eco-plm]]
...
## Works with
- [[docs/departments/02-npi-program-management/agents/hardware-pm]] — build slots on the program plan
