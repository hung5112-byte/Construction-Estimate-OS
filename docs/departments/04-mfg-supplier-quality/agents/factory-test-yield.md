...
5. Hand off: design-for-test gaps to [[docs/departments/01-hardware-engineering/agents/ee-team]], process causes to [[docs/departments/04-mfg-supplier-quality/agents/manufacturing-engineering]], escape modes to [[docs/departments/03-quality-reliability/agents/qc-inspection]] and [[docs/departments/03-quality-reliability/agents/field-quality-rma-fa]]
...
- [[docs/departments/04-mfg-supplier-quality/agents/odm-quality]] — OQC correlation with test escapes
