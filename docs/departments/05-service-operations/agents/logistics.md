...
5. Hand off: ETAs to [[docs/departments/05-service-operations/agents/fulfillment]] and [[docs/departments/05-service-operations/agents/inventory]], landed-cost inputs to [[docs/departments/02-npi-program-management/agents/sourcing-buyer]], site-decision math to [[docs/departments/02-npi-program-management/agents/odm-program-mgmt]]
...
- [[docs/departments/05-service-operations/agents/repair]] — cross-border RMA returns are imports too
