...
5. Hand off: spares needs to [[docs/departments/05-service-operations/agents/inventory]], recurring field issues to [[docs/departments/03-quality-reliability/agents/field-quality-rma-fa]], OTA staging with [[docs/departments/03-quality-reliability/agents/firmware-qa]]
...
## Works with
- [[docs/departments/05-service-operations/agents/fulfillment]] — kit arrival vs. install windows
- [[docs/departments/05-service-operations/agents/repair]] — field returns routing
