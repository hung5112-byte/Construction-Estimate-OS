...
5. Hand off: E&O exposure to [[docs/departments/02-npi-program-management/agents/bom-eco-plm]] and [[docs/departments/02-npi-program-management/agents/sourcing-buyer]], allocation to [[docs/departments/05-service-operations/agents/fulfillment]], quarantine lanes with [[docs/departments/05-service-operations/agents/repair]]
...
## Works with
- [[docs/departments/05-service-operations/agents/repair]] — RMA stock and repair-parts kanban
- [[docs/departments/05-service-operations/agents/fulfillment]] — allocation truth
