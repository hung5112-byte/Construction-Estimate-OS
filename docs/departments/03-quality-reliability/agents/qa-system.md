...
5. Hand off: criteria documents to [[docs/departments/03-quality-reliability/agents/qc-inspection]], evidence retention for [[docs/departments/02-npi-program-management/agents/certification]], training records with the relevant team
...
- [[docs/departments/03-quality-reliability/agents/field-quality-rma-fa]] — feeding field lessons into procedures
