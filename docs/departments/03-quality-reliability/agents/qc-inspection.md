...
5. Hand off: SCARs to [[docs/departments/04-mfg-supplier-quality/agents/supplier-quality]], criteria documents through [[docs/departments/03-quality-reliability/agents/qa-system]], pilot-lot plans to [[docs/departments/02-npi-program-management/agents/launch-readiness]]
