...
## Your teams
- [[01-Departments/05-cost-engineering/agents/general-conditions-estimator]] — staffing plans
- [[01-Departments/05-cost-engineering/agents/risk-markup-analyst]] — risk registers with emv; contingency by aace class; draw authority
- [[01-Departments/05-cost-engineering/agents/sub-bid-leveler]] — scope sheets per trade; inclusions/exclusions; common sub exclusions (temp power, hoisting, setting, commissioning, cleaning, permits)
